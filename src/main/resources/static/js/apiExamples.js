 ...
 */
document.getElementById('getMovies1' ).addEventListener('click', getMovies1);
document.getElementById('getMovies2' ).addEventListener('click', getMovies2);
document.getElementById('getWeather').addEventListener('click', getWeather);
document.getElementById('getNasa'   ).addEventListener('click', getNasa);

getLocation('weatherList');

function getMovies1() { getMovies('https://imdb-api.com/en/API/SearchMovie/k_qa7p2g6c/')}
function getMovies2() { getMovies('http://localhost:8080/api/movies/')}
/**
...
function getMovies(apiUrl) {
    ...
    let url = apiUrl + `${movieTitle.value}`;
    console.log(url);
